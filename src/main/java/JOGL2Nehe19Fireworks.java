 ...
 */
public class JOGL2Nehe19Fireworks implements com.jogamp.opengl.GLEventListener, KeyListener {
...
//   private static float speedXGlobal = 0.0f;
   ...
   private String textureFileName = "satellite.png";
   ...
   public static void main(String[] args) {
      ...
      com.jogamp.opengl.awt.GLCanvas canvas = new com.jogamp.opengl.awt.GLCanvas();  // heavy-weight GLCanvas
   ...
   public void init(com.jogamp.opengl.GLAutoDrawable drawable) {
      ...
      glu = new com.jogamp.opengl.glu.GLU();                         // get GL Utilities
...
//      gl.glDepthFunc(GL_LEQUAL);  // the type of depth test to do
      ...
      gl.glShadeModel(GLLightingFunc.GL_FLAT); // blends colors nicely, and smoothes out lighting

      gl.glEnable(GL.GL_BLEND); // Enable Blending
      gl.glBlendFunc(GL.GL_SRC_ALPHA, GL.GL_ONE); // Type Of Blending To Perform
      gl.glHint(GL2ES1.GL_POINT_SMOOTH_HINT, GL.GL_NICEST); // Really Nice Point Smoothing
   ...
   public void display(com.jogamp.opengl.GLAutoDrawable drawable) {
      ...
      for (int i = 0; i < MAX_PARTICLES; i++) {
         if (particles[i].active) {
            ...
            gl.glBegin(com.jogamp.opengl.GL2.GL_POLYGON); // build quad from a triangle strip
